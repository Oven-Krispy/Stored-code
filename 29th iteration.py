        ...
        if event.type == pygame.KEYDOWN:
          if event.key == pygame.K_y:
            ...
            while bet_input_active:
              for event in pygame.event.get():
                  if event.type == pygame.KEYDOWN:
                      if event.key == pygame.K_RETURN:
                          ...
                          self.display_fixed_text(user_funds, user_bet,
                          bot_funds, bot_bet, pot_total)
                          ...
                          # otherwise displays the text
      
              enter_bet_text = self.bet_font.render(f"Enter your bet: {user_input}",
              True, self.white_text)
              # sets the text to be displayed
              self.screen.blit(enter_bet_text, (20, 260))
              ...
              True, self.yellow_text)
              self.screen.blit(bot_bet_text, (400, 180))
