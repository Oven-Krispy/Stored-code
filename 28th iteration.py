...
class TexasHoldem:
  ...
  def play(self):
    self.bet_font = pygame.font.Font(None, 36)
    # sets the font for the bet input
    self.deal()
        ...
        if event.type == pygame.KEYDOWN:
          if event.key == pygame.K_y:
            ...
            while bet_input_active:
              ...
              bet_text = self.bet_font.render(f"Enter your bet: {user_input}", True, (0, 0, 0))
              self.screen.blit(bet_text, (20, 20))
              pygame.display.flip()
            ...
            if user_funds > 0:
              ...
              # allows the user to place their bet if they 
              # still have money
    
              while bet_allowed == False:
                hundreds_check = user_bet % 100
                # sets up variable to be used to check if 
                # input is a multiple of 100
                
                if user_bet < 100:
                  print("Bet is too low")
                  user_bet = int(input("Enter your bet: "))
                  # makes sure the user has placed a bet that
                  # is above 100 (the minimum)
                
                elif user_bet > user_max_bet:
                  print("Bet is too high")
                  user_bet = int(input("Enter your bet: "))
                  # makes sure the user hasn't bet more than
                  # their total funds (the maximum)
                    
                elif hundreds_check != 0:
                  print("Bet is not a multiple of 100")
                  user_bet = int(input("Enter your bet: "))
                  # makes sure the user's bet is a multiple
                  # of 100
              ...
              user_funds -= user_bet
              # removes the user's bet from their funds
            
            if bot_funds > 0:
              if user_bet > bot_bet:
                if user_bet > bot_max_bet:
                  bot_bet = bot_max_bet
                  bot_funds -= bot_bet
                else:
                  bot_bet = user_bet
            ...
            if user_funds > 0:
              if game_round == 1:
                ...
                print("The Flop:")
                # signifies the user is now betting on the flop
                game_round += 1
                ...
                # deals the turn card
                print("The Turn:")
                # signifies the user is now betting on the turn
                game_round += 1
                ...
                print("The River:")
                # signifies the user is now betting on the river
                ...
                print(name, "won with", win_type, "of high card",
                high_card)
                # outputs the winner
                pot_total = 0
                user_bet = 0
