...
class MainMenu:
    def __init__(self):
        ...
        self.start_button_rect = pygame.Rect(300, 350, 220, 90)
        ...
        self.mode_text_one = "Basic (1)"
        self.mode_text_two = "Tournament (2)"
        self.mode_text_three = 'One-on-one (3)'
        # sets the text for the mode checkboxes
        self.rules_text_one = "Antes (0)"
        self.rules_text_two = "Jackpots (9)"
        self.rules_text_three = "6 and 9 (8)"
        self.rules_text_four = "Purposeful pre-flop (7)"
        self.rules_text_five = "Top and tails (6)"
    ...
    def draw_start_button(self):
        ...
        text = self.font.render('Start (S)', True, (255, 255, 255))
