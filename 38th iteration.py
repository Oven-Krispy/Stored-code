...
class TexasHoldem:
        ...
        for event in pygame.event.get():
          if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_e:
              ...
              self.deal_hole_cards(user_funds, bot_funds, game_round, pot_total, user_bet, bot_bet, blinds, community_cards_total)
  ...
  def display_winner(self, bot_funds, user_funds, pot_total):
  ...
  def deal_hole_cards(self, user_funds, bot_funds, game_round, pot_total, user_bet, bot_bet, blinds, community_cards_total):
    if user_funds > 0:
      if game_round == 1:
        ...
        self.display_winner(bot_funds, user_funds, pot_total)
